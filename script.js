const apiKey = "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";

const maxImages = 4; // Number of imgs to generate for each prompt.
...
document.getElementById("user-prompt").addEventListener("keypress", (event) => {
  if (event.key === "Enter") {
